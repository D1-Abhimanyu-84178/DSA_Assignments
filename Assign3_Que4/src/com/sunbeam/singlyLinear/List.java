package com.sunbeam.singlyLinear;
...
public class List {
   ...
   public void sortedInsetion(int value) {
	   ...
	   while(trav != null) {
		   ...
		   else if (value > trav.data && trav.next == null) {
			   trav.next = newnode;
			   break;
			   
		   }else if(value > trav.data && value < trav.next.data) {
			   newnode.next = trav.next;
			   trav.next = newnode;
			   break;
		   }
