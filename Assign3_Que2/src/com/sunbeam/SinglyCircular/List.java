...
import com.sunbeam.SinglyCircular.List.Node;
...
//	private Node head;
	...
	public void insertAfterNode(int value, int pos) {
	  if(pos < 1 || pos > count) {
		 System.out.println("invalid position");
	  }
     ...
     public void insertBeforeNode(int value, int pos) {
    	 ...
    	 if(tail ==  null) {
    		 addFirst(value);
    		 System.out.println("List was empty element is added at first position");
    		 return; 
    	 }
    	 else {
    		 Node newnode = new Node(value);
